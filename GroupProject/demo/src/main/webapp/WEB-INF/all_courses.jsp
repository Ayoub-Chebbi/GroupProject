...
h1 {
 ...
 section {
    background: -webkit-linear-gradient(left, #24233b, #242525);
    background: linear-gradient(to right, #2e2b35, #2a243d);
                      ...
                      <td>${course.description}</td>
                        <td>
                            <div class="butt">
                                ...
                                <button >
                                  <a href="/api/instructor/add-course-to-user">add course to user</a>
